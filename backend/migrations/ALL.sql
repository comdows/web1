...
-- 구성: 0001 스키마 → 0002 RLS → 0003 시드 → 0004 오픈 → 0005 소개·동의·탈퇴 → 0006 AI → 0007 정정 → 0008 하드닝 → 0009 계정 → 0010 운영 → 0011 과금 → 0012 과금 하드닝 → 0013 QA3
-- ============================================================
...
insert into public.platforms (id, name, category_id, region, url, blurb, is_new) values
  ...
  ('coupanglive', '쿠팡 라이브', 'live', 'domestic', 'https://livecreator.coupang.com/', '쿠팡 내 라이브 방송 판매.', false),
  ...
  ('shopify', '쇼피파이', 'global', 'overseas', 'https://www.shopify.com/kr', '다국어·다통화 자사몰로 해외 직접 판매 솔루션.', false),
  ('cafe24', '카페24 글로벌', 'global', 'overseas', 'https://www.cafe24.com/ecommerce/global/', '다국어 쇼핑몰·해외결제·배송 지원 솔루션.', false),
  ('global', '메이크샵 글로벌', 'global', 'overseas', 'https://global.makeshop.com/', '영·일·중 통합 쇼핑몰 해외판매 솔루션.', false),
  ...
  ('musinsa2', '무신사 글로벌', 'global', 'overseas', 'https://global.musinsa.com/', 'K-패션 브랜드 해외 소비자 대상 역직구 스토어.', false),
  ('malltail', '몰테일', 'global', 'overseas', 'https://www.malltail.com/', '9개국 물류 기반 역직구·해외배송 대행.', false),
  ('delivered', '딜리버드 코리아', 'global', 'overseas', 'https://www.delivered.co.kr/', '한국 셀러 해외판매·배송 크로스보더 서비스.', false),
  ('sellerhub', '셀러허브', 'global', 'overseas', 'https://www.sellerhub.co.kr/', '국내외 쇼핑몰 통합 관리 멀티채널 판매 솔루션.', false),
  ('shopigate', '쇼피게이트', 'global', 'overseas', 'https://shopigate.co.kr/', '쇼피파이 스토어 구축~해외물류 역직구 대행.', false),
  ...
  ('sell3', 'Fruugo', 'global', 'overseas', 'https://sell.fruugo.com/en/', '40여 개국 다국어·다통화로 자동 노출되는 크로스보더 마켓플레이스.', false),
  ('kogan', 'Kogan Marketplace', 'global', 'overseas', 'https://www.kogan.com/au/kogan-marketplace/', '호주 코간닷컴의 서드파티 셀러 마켓플레이스.', false),
  ('reverb', 'Reverb', 'global', 'overseas', 'https://reverb.com/selling', '신품·빈티지 악기와 음향장비 전문 글로벌 셀러 마켓.', false),
  ...
  ('globalsellers', '쿠팡 글로벌셀러', 'global', 'overseas', 'https://globalsellers.coupang.com/', '국내 제조·판매사가 대만 등 쿠팡 해외 채널로 진출하는 글로벌셀러 프로그램.', false),
  ...
  ('agoda', '아고다', 'space', 'overseas', 'https://www.agoda.com/ko-kr/', '호텔·숙소 예약 글로벌 OTA 플랫폼.', false),
  ('booking', '부킹닷컴', 'space', 'overseas', 'https://www.booking.com/', '전 세계 숙소·호텔 예약 글로벌 OTA.', false),
  ('hotelscombined', '호텔스컴바인', 'space', 'overseas', 'https://www.hotelscombined.com/', '호텔 가격 비교 메타서치 플랫폼.', false),
  ('trivago', '트리바고', 'space', 'overseas', 'https://www.trivago.com/', '호텔 가격 비교 메타서치.', false),
  ('kr2', '트립닷컴', 'space', 'overseas', 'https://kr.trip.com/', '항공·호텔·투어 종합 여행 예약 플랫폼.', false),
  ...
  ('youtube', '유튜브', 'content', 'overseas', 'https://www.youtube.com', '영상 콘텐츠 게시·광고 수익화.', false),
...
insert into public.platforms (id, name, category_id, region, url, blurb, is_new) values
  ...
  ('noom', '눔', 'beautyhealth', 'overseas', 'https://www.noom.com/', '식단·운동·습관 코칭 헬스케어 앱.', false),
  ...
  ('stipop', '스티팝', 'assets', 'overseas', 'https://stipop.io/', '작가 스티커(이모티콘)를 글로벌 메신저에 유통하는 스티커 API 플랫폼.', false),
