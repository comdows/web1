...
insert into public.platforms (id, name, category_id, region, url, blurb, is_new, fee_band, fee_text, settle_text, enter_text, strength) values
  ...
  ('cafe242', '카페24', 'mallbuilder', 'domestic', 'https://www.cafe24.com/', '자사몰 구축·호스팅 이커머스 솔루션.', false, 'low', '무료 개설형(판매 수수료 없음·결제수수료 별도)', null, '회원가입 후 쇼핑몰 개설(판매 시 사업자등록)', '자사몰 구축·해외판매·마케팅 연동 폭넓음'),
  ('imweb', '아임웹', 'mallbuilder', 'domestic', 'https://imweb.me/', '노코드 드래그 방식 자사몰·웹사이트 빌더.', false, 'low', '월 구독형(판매 수수료 없음·결제수수료 별도)', null, '회원가입 후 쇼핑몰·홈페이지 개설', '노코드 드래그로 빠른 자사몰 제작'),
  ('sixshop', '식스샵', 'mallbuilder', 'domestic', 'https://www.sixshop.com/', '디자인 템플릿 기반 노코드 자사몰 제작.', false, 'low', '월 구독형(판매 수수료 없음·결제수수료 별도)', null, '회원가입 후 쇼핑몰 개설(판매 시 사업자등록)', '디자인 템플릿 중심 브랜드몰 제작'),
  ('makeshop', '메이크샵', 'mallbuilder', 'domestic', 'https://www.makeshop.co.kr/', '임대형 쇼핑몰 구축 솔루션.', false, 'low', '월 구독형(판매 수수료 없음·결제수수료 별도)', null, '회원가입 후 임대형 쇼핑몰 구축', '임대형 쇼핑몰 기능·확장 옵션 다양'),
  ...
  ('soomgo', '숨고', 'freelance', 'domestic', 'https://soomgo.com', '레슨·이사·수리 등 생활 전문가 매칭.', false, 'low', '판매 수수료 없음 — 견적 발송 시 크레딧 차감(리드 과금형)', null, '전문가 가입·프로필 등록 후 견적 발송', '레슨·이사·수리 등 생활 전문가 매칭에 강점'),
  ('wishket', '위시켓', 'freelance', 'domestic', 'https://www.wishket.com', 'IT 개발·디자인 프로젝트 외주 매칭.', false, 'mid', '낙찰 시 파트너 측 정률 수수료', null, '파트너 가입·검증 후 프로젝트 지원', 'IT 개발·디자인 프로젝트 외주 매칭에 강점'),
  ('taling', '탈잉', 'freelance', 'domestic', 'https://taling.me', '취미·직무 원데이 클래스·튜터 매칭.', false, 'high', '클래스 판매 정률 수수료(높은 편으로 알려짐)', null, '튜터 가입·클래스 등록 후 개설', '취미·직무 원데이 클래스·튜터 매칭에 강점'),
  ...
  ('spacecloud', '스페이스클라우드', 'space', 'domestic', 'https://www.spacecloud.kr', '모임·연습·촬영 공간 시간 대여.', false, 'mid', '공간 호스트 정률 수수료', null, '공간 호스트 등록 후 게시', '모임·연습·촬영 공간 시간 단위 대여'),
  ('catchtable', '캐치테이블', 'space', 'domestic', 'https://www.catchtable.co.kr', '식당 예약·웨이팅 중개.', false, 'low', '매장 월 구독형(예약 건당 수수료 없음으로 알려짐)', null, '식당 사업자 제휴 등록 후 이용', '식당 예약·웨이팅 관리에 강점'),
  ...
  ('frip', '프립', 'space', 'domestic', 'https://www.frip.co.kr/', '취미 클래스·액티비티·모임 예약 여가 플랫폼.', false, 'mid', '호스트 판매 정률 수수료', null, '호스트 가입·클래스 개설 후 심사', '취미 클래스·여가 액티비티 모객에 강점'),
  ...
  ('hourplace', '아워플레이스', 'space', 'domestic', 'https://hourplace.co.kr/', '촬영 스튜디오·공간 시간제 예약 대여.', false, 'mid', '촬영 공간 호스트 정률 수수료', null, '공간 호스트 등록·심사 후 게시', '촬영 스튜디오·공간 시간제 대여에 강점'),
  ...
  ('class101', '클래스101', 'content', 'domestic', 'https://class101.net', '온라인 클래스 제작·판매(크리에이터).', false, null, '구독 수익 배분형(요율 비공개)', null, '크리에이터 지원·심사 후 클래스 개설', '취미·실무 온라인 클래스 제작·판매에 강점'),
  ...
  ('postype', '포스타입', 'content', 'domestic', 'https://www.postype.com/', '창작 콘텐츠 유료 판매·후원·멤버십 커뮤니티.', false, 'mid', '콘텐츠 판매 정률 수수료', null, '가입 후 창작자 등록·콘텐츠 발행', '웹툰·웹소설 등 창작 콘텐츠 유료 판매·후원에 강점'),
  ...
  ('oliveyoung', '올리브영 온라인몰', 'fashion', 'domestic', 'https://www.oliveyoung.co.kr/', 'CJ올리브영의 뷰티·헬스 상품 온라인몰.', false, null, '입점 협의형(공개 요율 없음)', null, '브랜드 입점 제안·심사 후 매입/입점', '뷰티·헬스 상품, 오프라인 연계 온라인몰'),
  ...
  ('kurly', '마켓컬리', 'food', 'domestic', 'https://www.kurly.com', '신선식품 새벽배송 이커머스.', false, null, '입점 협의형(사입·위탁 — 공개 요율 없음)', null, '사업자등록 후 상품 제안·입점 심사', '신선식품 새벽배송·큐레이션 상품 구성'),
...
insert into public.platforms (id, name, category_id, region, url, blurb, is_new, fee_band, fee_text, settle_text, enter_text, strength) values
  ...
  ('saramin', '사람인', 'jobs', 'domestic', 'https://www.saramin.co.kr', '정규·경력직 채용 매칭 플랫폼.', false, 'low', '공고 게재·채용 상품 구매형(거래 수수료 없음)', null, '기업 회원가입 후 채용공고 등록', '정규·경력직 채용 매칭에 강점'),
  ('jobkorea', '잡코리아', 'jobs', 'domestic', 'https://www.jobkorea.co.kr', '종합 채용 정보 플랫폼.', false, 'low', '공고 게재·채용 상품 구매형(거래 수수료 없음)', null, '기업 회원가입 후 채용공고 등록', '종합 채용 정보·구인구직에 강점'),
  ('albamon', '알바몬', 'jobs', 'domestic', 'https://www.albamon.com', '아르바이트·단기 일자리 중개.', false, 'low', '공고 게재 상품형(거래 수수료 없음)', null, '사업자·개인 고용주 가입 후 공고 등록', '아르바이트·단기 일자리 중개에 강점'),
  ...
  ('miso', '미소', 'homeservice', 'domestic', 'https://miso.kr', '가사·청소·이사 등 홈서비스 매칭.', false, 'mid', '파트너 매칭 정률 수수료', null, '앱 가입 후 서비스 예약·이용', '가사·청소·이사 등 홈서비스 매칭에 강점'),
  ('cleanlab', '청소연구소', 'homeservice', 'domestic', 'https://www.cleaninglab.co.kr', '가사도우미·홈클리닝 매칭.', false, 'mid', '매니저 매칭 정률 수수료', null, '앱 가입 후 서비스 예약·이용', '정기·가사 홈클리닝 매칭에 강점'),
  ...
  ('zigbang', '직방', 'realestate', 'domestic', 'https://www.zigbang.com', '원룸·오피스텔·아파트 등 주거 부동산 중개.', false, 'low', '중개사 광고 상품형(이용자 수수료 없음)', null, '중개사무소는 제휴 가입 후 매물 등록', '원룸·오피스텔 등 주거 매물 탐색에 강점'),
  ('dabang', '다방', 'realestate', 'domestic', 'https://www.dabangapp.com', '주거용 부동산 매물 정보.', false, 'low', '중개사 광고 상품형(이용자 수수료 없음)', null, '중개사무소는 제휴 가입 후 매물 등록', '주거용 매물 정보 탐색에 강점'),
  ...
  ('encar', '엔카', 'auto', 'domestic', 'https://www.encar.com', '국내 대표 중고차 거래 플랫폼.', false, 'low', '딜러 등록·광고 상품형(개인 구매자 수수료 없음)', null, '딜러 등록 또는 개인 매물 등록 후 이용', '중고차 매물 검색·시세 확인에 강점'),
  ('heydealer', '헤이딜러', 'auto', 'domestic', 'https://www.heydealer.com', '내 차 팔기(딜러 경매) 중개.', false, 'low', '판매자 무료 — 낙찰 딜러 측 수수료', null, '앱에서 차량 등록 후 딜러 견적 수령', '딜러 경매 방식 내차 팔기에 강점'),
...
insert into public.platforms (id, name, category_id, region, url, blurb, is_new, fee_band, fee_text, settle_text, enter_text, strength) values
  ...
  ('lawtalk', '로톡', 'legaltax', 'domestic', 'https://www.lawtalk.co.kr/', '변호사 검색·전화/영상/방문 법률 상담 매칭.', false, 'low', '변호사 광고 구독형(사건 수임 수수료 없음)', null, '변호사는 자격 인증 후 프로필 등록, 이용자는 가입 후 상담', '변호사 검색·전화/영상/방문 법률 상담 매칭에 강점'),
...
insert into public.platforms (id, name, category_id, region, url, blurb, is_new, fee_band, fee_text, settle_text, enter_text, strength) values
  ...
  ('aistudios', 'AI스튜디오스', 'ai_video', 'domestic', 'https://www.aistudios.com', 'AI 아바타·텍스트 투 비디오 제작 SaaS.', false, null, null, null, '가입 후 사용(요금제 구독)', 'AI 아바타·텍스트 투 비디오 제작에 강점'),
  ...
  ('deepseek', 'DeepSeek', 'ai_chat', 'overseas', 'https://chat.deepseek.com', '추론 특화 오픈 모델 기반의 무료 범용 AI 챗봇.', true, null, null, null, '가입 후 바로 사용(무료)', '수학·코딩 등 추론 답변을 무료로 쓰는 데 강점'),
  ('qwen-chat', 'Qwen Chat', 'ai_chat', 'overseas', 'https://chat.qwen.ai', '알리바바 Qwen 모델 기반의 다국어 AI 챗봇.', true, null, null, null, '가입 후 바로 사용(무료)', '다국어·이미지 이해를 무료로 쓰는 데 강점'),
  ('poe', 'Poe', 'ai_chat', 'overseas', 'https://poe.com', 'GPT·Claude 등 여러 AI 모델을 한 곳에서 골라 쓰는 허브.', true, null, null, null, '가입 후 바로 사용(무료 크레딧·구독형)', '여러 모델을 한 구독으로 비교해 쓰는 데 강점'),
  ('meta-ai', 'Meta AI', 'ai_chat', 'overseas', 'https://www.meta.ai', '메타 Llama 모델 기반의 무료 AI 어시스턴트.', true, null, null, null, '가입 후 바로 사용(무료)', '이미지 생성 포함 무료 범용 어시스턴트로 강점'),
  ('kimi', 'Kimi', 'ai_chat', 'overseas', 'https://www.kimi.com', '긴 문서 이해에 강한 문샷AI의 AI 챗봇.', true, null, null, null, '가입 후 바로 사용(무료)', '긴 문서·파일을 통째로 읽히는 데 강점'),
  ('pi-ai', 'Pi', 'ai_chat', 'overseas', 'https://pi.ai', '대화 감성에 특화된 개인 비서형 AI 챗봇.', true, null, null, null, '가입 후 바로 사용(무료)', '부드러운 대화형 상담·아이디어 정리에 강점'),
  ('adot', '에이닷', 'ai_chat', 'domestic', 'https://adot.ai', 'SK텔레콤의 한국어 AI 개인 비서(통화 요약·일정 관리).', true, null, null, null, '가입 후 바로 사용(무료)', '한국어 일상 비서·통화 요약 연동에 강점'),
  ('quillbot', 'QuillBot', 'ai_writing', 'overseas', 'https://quillbot.com', '문장 바꿔쓰기·요약·문법 교정을 한 번에 하는 영어 글쓰기 도구.', true, null, null, null, '가입 없이 일부 사용(무료 플랜·구독형)', '영문 패러프레이즈·요약 품질에 강점'),
  ('wordtune', 'Wordtune', 'ai_writing', 'overseas', 'https://www.wordtune.com', '문장의 톤·길이를 다듬어 주는 영어 리라이팅 도구.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '이메일·비즈니스 문장 톤 조절에 강점'),
  ('rytr', 'Rytr', 'ai_writing', 'overseas', 'https://rytr.me', '템플릿 기반으로 카피·블로그 초안을 빠르게 뽑는 저가형 글쓰기 AI.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '저렴한 요금으로 다량 초안 생성에 강점'),
  ('languagetool', 'LanguageTool', 'ai_writing', 'overseas', 'https://languagetool.org', '30여 개 언어를 지원하는 문법·맞춤법 교정기.', true, null, null, null, '가입 없이 일부 사용(무료 플랜·구독형)', '다국어 문법 교정과 브라우저 연동에 강점'),
  ('beautiful-ai', 'Beautiful.ai', 'ai_writing', 'overseas', 'https://www.beautiful.ai', '슬라이드 레이아웃을 자동 정돈해 주는 AI 발표자료 도구.', true, null, null, null, '가입 후 사용(체험 후 구독형)', '디자인 감각 없이도 정돈된 슬라이드 제작에 강점'),
  ('pitch', 'Pitch', 'ai_writing', 'overseas', 'https://pitch.com', '팀 협업형 발표자료 제작 도구(AI 초안 생성 지원).', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '팀 단위 발표자료 협업·AI 초안에 강점'),
  ('napkin-ai', 'Napkin AI', 'ai_writing', 'overseas', 'https://www.napkin.ai', '글을 붙여넣으면 도식·다이어그램을 자동 생성하는 도구.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '텍스트를 발표용 도식으로 바꾸는 데 강점'),
  ('imagefx', 'Google ImageFX', 'ai_image', 'overseas', 'https://labs.google/fx', '구글 Imagen 모델 기반의 무료 이미지 생성 실험 도구.', true, null, null, null, '구글 계정으로 바로 사용(무료)', '무료로 고품질 이미지 생성을 시험하는 데 강점'),
  ('krea', 'Krea', 'ai_image', 'overseas', 'https://www.krea.ai', '실시간 캔버스·업스케일을 갖춘 이미지·영상 생성 스튜디오.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '실시간 생성 캔버스와 업스케일에 강점'),
  ('playground-ai', 'Playground', 'ai_image', 'overseas', 'https://playground.com', '로고·포스터 등 그래픽 디자인 특화 이미지 생성 도구.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '상업용 그래픽·목업 제작에 강점'),
  ('freepik-ai', 'Freepik AI', 'ai_image', 'overseas', 'https://www.freepik.com/ai', '스톡 이미지 서비스 프리픽의 생성·편집 AI 모음.', true, null, null, null, '가입 후 바로 사용(무료 크레딧·구독형)', '스톡 소스와 생성 AI를 한 구독으로 쓰는 데 강점'),
  ('clipdrop', 'Clipdrop', 'ai_image', 'overseas', 'https://clipdrop.co', '배경 제거·조명 보정·업스케일 등 이미지 편집 AI 모음.', true, null, null, null, '가입 없이 일부 사용(무료 플랜·구독형)', '상품 사진 배경·조명 보정에 강점'),
  ('magnific', 'Magnific', 'ai_image', 'overseas', 'https://magnific.ai', '디테일을 되살리는 고품질 AI 업스케일러.', true, null, null, null, '가입 후 사용(구독형)', '저해상 이미지를 인쇄급으로 키우는 데 강점'),
  ('ms-designer', 'Microsoft Designer', 'ai_image', 'overseas', 'https://designer.microsoft.com', 'MS의 무료 AI 디자인·이미지 생성 도구.', true, null, null, null, 'MS 계정으로 바로 사용(무료)', 'SNS 카드·초대장 등 생활 디자인 무료 제작에 강점'),
  ('looka', 'Looka', 'ai_image', 'overseas', 'https://looka.com', '브랜드명만 넣으면 로고·브랜드 킷을 만들어 주는 AI.', true, null, null, null, '미리보기 무료(구매 시 결제)', '창업 초기 로고·브랜드 킷 제작에 강점'),
  ('kittl', 'Kittl', 'ai_image', 'overseas', 'https://www.kittl.com', '티셔츠·라벨 등 상업 디자인 특화 AI 디자인 툴.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '굿즈·패키지용 그래픽 제작에 강점'),
  ('pixlr', 'Pixlr', 'ai_image', 'overseas', 'https://pixlr.com', '브라우저에서 쓰는 포토샵 대체형 AI 사진 편집기.', true, null, null, null, '가입 없이 일부 사용(무료 플랜·구독형)', '설치 없이 브라우저 사진 보정에 강점'),
  ('lasco', '라스코 AI', 'ai_image', 'domestic', 'https://lasco.ai', '한국어 UI로 쓰는 국내 이미지 생성 AI 스튜디오.', true, null, null, null, '가입 후 바로 사용(무료 크레딧 제공)', '한국어 환경의 이미지 생성 워크플로에 강점'),
  ('google-flow', 'Google Flow (Veo)', 'ai_video', 'overseas', 'https://labs.google/flow', '구글 Veo 모델로 장면을 이어 붙이는 AI 영상 제작 도구.', true, null, null, null, '구글 계정으로 사용(구독 연동)', '고품질 텍스트→영상 생성(Veo)에 강점'),
  ('hailuo', 'Hailuo AI', 'ai_video', 'overseas', 'https://hailuoai.video', '미니맥스의 텍스트·이미지 기반 영상 생성 AI.', true, null, null, null, '가입 후 바로 사용(무료 크레딧 제공)', '인물 동작 표현의 영상 생성에 강점'),
  ('vidu', 'Vidu', 'ai_video', 'overseas', 'https://www.vidu.com', '캐릭터 일관성을 유지하는 텍스트→영상 생성 AI.', true, null, null, null, '가입 후 바로 사용(무료 크레딧 제공)', '캐릭터 일관성 있는 짧은 영상 생성에 강점'),
  ('opusclip', 'OpusClip', 'ai_video', 'overseas', 'https://www.opus.pro', '긴 영상을 쇼츠·릴스용 클립으로 잘라 주는 AI.', true, null, null, null, '가입 후 바로 사용(무료 체험 제공)', '롱폼→쇼츠 자동 클립·자막에 강점'),
  ('invideo', 'InVideo', 'ai_video', 'overseas', 'https://invideo.io', '프롬프트로 내레이션 포함 영상을 만드는 AI 영상 제작기.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '프롬프트 한 줄로 완성형 홍보 영상 제작에 강점'),
  ('fliki', 'Fliki', 'ai_video', 'overseas', 'https://fliki.ai', '글을 AI 음성 내레이션 영상으로 바꿔 주는 도구.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '블로그 글→내레이션 영상 변환에 강점'),
  ('veed', 'VEED', 'ai_video', 'overseas', 'https://www.veed.io', '자막·번역·녹화까지 되는 브라우저 영상 편집기.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '브라우저에서 자막·번역 편집에 강점'),
  ('d-id', 'D-ID', 'ai_video', 'overseas', 'https://www.d-id.com', '사진 한 장으로 말하는 아바타 영상을 만드는 AI.', true, null, null, null, '가입 후 바로 사용(무료 체험 제공)', '사진 기반 말하는 아바타 생성에 강점'),
  ('colossyan', 'Colossyan', 'ai_video', 'overseas', 'https://www.colossyan.com', '교육·사내 영상용 AI 아바타 프레젠터 제작 도구.', true, null, null, null, '가입 후 사용(체험 후 구독형)', '교육·온보딩 영상 아바타 제작에 강점'),
  ('playht', 'PlayHT', 'ai_audio', 'overseas', 'https://play.ht', '다국어 AI 음성 합성·클로닝 서비스.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '다국어 TTS·음성 클로닝 API에 강점'),
  ('speechify', 'Speechify', 'ai_audio', 'overseas', 'https://speechify.com', '문서·웹페이지를 자연스러운 음성으로 읽어 주는 TTS.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '긴 글을 듣기로 소비하는 데 강점'),
  ('lalal-ai', 'LALAL.AI', 'ai_audio', 'overseas', 'https://www.lalal.ai', '음원에서 보컬·악기를 분리하는 스템 분리 AI.', true, null, null, null, '가입 없이 일부 사용(종량제)', '보컬·MR 분리 품질에 강점'),
  ('krisp', 'Krisp', 'ai_audio', 'overseas', 'https://krisp.ai', '통화·회의 소음을 실시간 제거하는 AI 오디오 필터.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '실시간 통화 소음·에코 제거에 강점'),
  ('aiva', 'AIVA', 'ai_audio', 'overseas', 'https://www.aiva.ai', '영상·게임용 배경음악을 작곡하는 AI.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '분위기 지정 배경음악 작곡에 강점'),
  ('mubert', 'Mubert', 'ai_audio', 'overseas', 'https://mubert.com', '로열티 걱정 없는 스트리밍형 AI 음악 생성 서비스.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '콘텐츠용 로열티프리 BGM 생성에 강점'),
  ('soundraw', 'Soundraw', 'ai_audio', 'overseas', 'https://soundraw.io', '길이·분위기를 지정해 BGM을 만드는 AI 작곡 도구.', true, null, null, null, '가입 후 사용(체험 후 구독형)', '영상 길이에 맞춘 BGM 제작에 강점'),
  ('resemble', 'Resemble AI', 'ai_audio', 'overseas', 'https://www.resemble.ai', '기업용 음성 클로닝·더빙 AI 플랫폼.', true, null, null, null, '가입 후 사용(체험 후 구독형)', '브랜드 보이스 클로닝·현지화 더빙에 강점'),
  ('jetbrains-ai', 'JetBrains AI', 'ai_code', 'overseas', 'https://www.jetbrains.com/ai', 'IntelliJ 등 JetBrains IDE에 내장된 AI 코딩 어시스턴트.', true, null, null, null, 'IDE에서 활성화(구독형)', 'JetBrains IDE 사용자라면 자연스러운 통합에 강점'),
  ('amazon-q', 'Amazon Q Developer', 'ai_code', 'overseas', 'https://aws.amazon.com/q/developer', 'AWS 특화 AI 코딩·운영 어시스턴트.', true, null, null, null, 'AWS 계정으로 사용(무료 티어 제공)', 'AWS 인프라 코드·운영 자동화에 강점'),
  ('tabnine', 'Tabnine', 'ai_code', 'overseas', 'https://www.tabnine.com', '프라이버시 중심의 온프레미스 지원 AI 코드 자동완성.', true, null, null, null, 'IDE 플러그인 설치 후 사용(무료 플랜 제공)', '코드 유출 걱정 없는 사내 배포에 강점'),
  ('cody', 'Sourcegraph Cody', 'ai_code', 'overseas', 'https://sourcegraph.com/cody', '대형 코드베이스 검색과 결합한 AI 코딩 어시스턴트.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '대규모 저장소 맥락 이해에 강점'),
  ('openai-codex', 'OpenAI Codex', 'ai_code', 'overseas', 'https://openai.com/codex', '작업을 맡기면 코드를 짜서 PR로 돌려주는 OpenAI의 코딩 에이전트.', true, null, null, null, 'ChatGPT 구독으로 사용', '장시간 자율 코딩 작업 위임에 강점'),
  ('gemini-code', 'Gemini Code Assist', 'ai_code', 'overseas', 'https://codeassist.google', '구글 Gemini 기반의 무료 개인용 AI 코딩 도구.', true, null, null, null, '구글 계정으로 사용(개인 무료)', '무료 개인 플랜의 넉넉한 사용량에 강점'),
  ('base44', 'Base44', 'ai_code', 'overseas', 'https://base44.com', '말로 설명하면 DB 포함 앱을 만들어 주는 노코드 AI 빌더.', true, null, null, null, '가입 후 바로 사용(무료 크레딧 제공)', '비개발자의 사내 도구·앱 제작에 강점'),
  ('firebase-studio', 'Firebase Studio', 'ai_code', 'overseas', 'https://firebase.studio', '구글의 브라우저 기반 AI 풀스택 앱 개발 환경.', true, null, null, null, '구글 계정으로 바로 사용(무료)', '프로토타입→배포까지 브라우저 완결에 강점'),
  ('trae', 'Trae', 'ai_code', 'overseas', 'https://www.trae.ai', '바이트댄스의 무료 지향 AI 코드 에디터.', true, null, null, null, '설치 후 바로 사용(무료 중심)', '무료로 쓰는 AI IDE로 강점'),
  ('warp', 'Warp', 'ai_code', 'overseas', 'https://www.warp.dev', 'AI 에이전트를 내장한 차세대 터미널.', true, null, null, null, '설치 후 바로 사용(무료 플랜 제공)', '터미널 작업의 AI 자동화에 강점'),
  ('granola-ai', 'Granola', 'ai_meeting', 'overseas', 'https://www.granola.ai', '내 메모와 녹음을 합쳐 회의록을 완성하는 AI 노트패드.', true, null, null, null, '설치 후 바로 사용(무료 체험 제공)', '봇 없이 조용히 기록되는 회의 노트에 강점'),
  ('notta', 'Notta', 'ai_meeting', 'overseas', 'https://www.notta.ai', '다국어 회의 녹음·전사·요약 서비스(한국어 지원).', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '한국어 포함 다국어 전사 품질에 강점'),
  ('read-ai', 'Read AI', 'ai_meeting', 'overseas', 'https://www.read.ai', '회의·메일·메신저를 아우르는 업무 요약 코파일럿.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '회의+메일 통합 요약·검색에 강점'),
  ('circleback', 'Circleback', 'ai_meeting', 'overseas', 'https://circleback.ai', '회의에서 할 일·결정사항을 자동 추출하는 AI 회의록.', true, null, null, null, '가입 후 바로 사용(무료 체험 제공)', '액션 아이템 자동 정리·후속 연동에 강점'),
  ('sovoro', '소보로', 'ai_meeting', 'domestic', 'https://sovoro.kr', '실시간 한국어 음성 자막 서비스(회의·강의·방송).', true, null, null, null, '가입 후 사용(체험 후 구독형)', '실시간 한국어 자막·속기 대체에 강점'),
  ('plaud', 'Plaud', 'ai_meeting', 'overseas', 'https://www.plaud.ai', '녹음 하드웨어와 연동되는 AI 회의·통화 요약 서비스.', true, null, null, null, '기기 구매 후 앱 연동(구독형)', '오프라인 대화·통화 기록의 자동 요약에 강점'),
  ('chatbase', 'Chatbase', 'ai_marketing', 'overseas', 'https://www.chatbase.co', '내 문서·사이트를 학습시켜 만드는 고객상담 AI 챗봇 빌더.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '자사 데이터 기반 상담봇을 코드 없이 만드는 데 강점'),
  ('creatify', 'Creatify', 'ai_marketing', 'overseas', 'https://creatify.ai', '상품 URL만 넣으면 광고 영상을 만들어 주는 AI.', true, null, null, null, '가입 후 바로 사용(무료 크레딧 제공)', '커머스 상품 광고 영상 자동 제작에 강점'),
  ('arcads', 'Arcads', 'ai_marketing', 'overseas', 'https://www.arcads.ai', 'AI 배우로 UGC 스타일 광고 영상을 만드는 도구.', true, null, null, null, '가입 후 사용(구독형)', '실사형 UGC 광고 소재 대량 제작에 강점'),
  ('ocoya', 'Ocoya', 'ai_marketing', 'overseas', 'https://www.ocoya.com', 'SNS 콘텐츠 생성·예약 발행을 한 번에 하는 마케팅 AI.', true, null, null, null, '가입 후 바로 사용(무료 체험 제공)', 'SNS 카피+이미지+예약 발행 일원화에 강점'),
  ('vcat', '브이캣', 'ai_marketing', 'domestic', 'https://vcat.ai', '상품 URL로 광고 영상·배너를 자동 생성하는 국내 서비스.', true, null, null, null, '가입 후 바로 사용(무료 체험 제공)', '한국 커머스 광고 소재 자동화에 강점'),
  ('gorgias', 'Gorgias', 'ai_marketing', 'overseas', 'https://www.gorgias.com', '이커머스 특화 AI 고객응대 헬프데스크.', true, null, null, null, '가입 후 사용(체험 후 구독형)', '쇼핑몰 CS 자동 응답·주문 연동에 강점'),
  ('crisp', 'Crisp', 'ai_marketing', 'overseas', 'https://crisp.chat', '채팅 위젯·챗봇·공유 인박스를 갖춘 고객 메시징 플랫폼.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '소규모 팀의 올인원 고객 채팅에 강점'),
  ('gumloop', 'Gumloop', 'ai_auto', 'overseas', 'https://www.gumloop.com', '드래그앤드롭으로 AI 업무 자동화를 만드는 노코드 툴.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', 'AI 단계가 들어간 업무 플로 구축에 강점'),
  ('bardeen', 'Bardeen', 'ai_auto', 'overseas', 'https://www.bardeen.ai', '브라우저 반복 작업을 자동화하는 AI 확장 프로그램.', true, null, null, null, '확장 설치 후 바로 사용(무료 플랜 제공)', '웹 스크랩·영업 리서치 자동화에 강점'),
  ('activepieces', 'Activepieces', 'ai_auto', 'overseas', 'https://www.activepieces.com', '오픈소스 노코드 자동화 플랫폼(셀프호스팅 가능).', true, null, null, null, '클라우드 가입 또는 셀프호스팅(오픈소스)', '오픈소스라 비용·데이터 통제에 강점'),
  ('flowise', 'Flowise', 'ai_auto', 'overseas', 'https://flowiseai.com', 'LLM 에이전트·챗봇을 시각적으로 조립하는 오픈소스 빌더.', true, null, null, null, '클라우드 가입 또는 셀프호스팅(오픈소스)', '시각적 LLM 워크플로 조립에 강점'),
  ('crewai', 'CrewAI', 'ai_auto', 'overseas', 'https://www.crewai.com', '여러 AI 에이전트를 팀처럼 굴리는 멀티에이전트 프레임워크.', true, null, null, null, '가입 후 사용(오픈소스+클라우드)', '역할 분담형 멀티에이전트 구축에 강점'),
  ('genspark', 'Genspark', 'ai_auto', 'overseas', 'https://www.genspark.ai', '조사·제작·전화까지 대신하는 범용 AI 에이전트.', true, null, null, null, '가입 후 바로 사용(무료 크레딧 제공)', '슬라이드·리서치 등 결과물 완성형 위임에 강점'),
  ('dalpha', '달파', 'ai_auto', 'domestic', 'https://dalpha.so', '기업 업무에 맞춘 AI 에이전트를 구축해 주는 국내 서비스.', true, null, null, null, '도입 상담 후 구축(B2B)', '한국 기업 맞춤 AI 도입·구축에 강점'),
  ('browse-ai', 'Browse AI', 'ai_auto', 'overseas', 'https://www.browse.ai', '코딩 없이 웹사이트 데이터를 추출·모니터링하는 도구.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '경쟁사 가격·재고 모니터링 자동화에 강점'),
  ('scispace', 'SciSpace', 'ai_research', 'overseas', 'https://scispace.com', '논문 검색·요약·질의응답을 돕는 연구 AI.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '논문 읽기·문헌 정리 속도에 강점'),
  ('semantic-scholar', 'Semantic Scholar', 'ai_research', 'overseas', 'https://www.semanticscholar.org', '앨런AI연구소의 무료 AI 학술 검색 엔진.', true, null, null, null, '가입 없이 바로 사용(무료)', '무료 학술 검색·인용 그래프에 강점'),
  ('researchrabbit', 'ResearchRabbit', 'ai_research', 'overseas', 'https://www.researchrabbit.ai', '논문 연결망을 시각화해 관련 연구를 찾아 주는 도구.', true, null, null, null, '가입 후 바로 사용(무료)', '인용 관계 기반 문헌 탐색에 강점'),
  ('scite', 'Scite', 'ai_research', 'overseas', 'https://scite.ai', '인용이 지지인지 반박인지 분류해 주는 근거 검증 AI.', true, null, null, null, '가입 후 사용(체험 후 구독형)', '주장별 지지·반박 인용 검증에 강점'),
  ('felo', 'Felo', 'ai_research', 'overseas', 'https://felo.ai', '출처를 보여 주는 다국어 AI 검색 엔진.', true, null, null, null, '가입 없이 일부 사용(무료 플랜 제공)', '아시아권 언어 출처 검색에 강점'),
  ('goover', '구버', 'ai_research', 'domestic', 'https://goover.ai', '주제를 등록하면 매일 브리핑을 만들어 주는 국내 AI 리서치 서비스.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '한국어 심층 리서치 리포트 자동화에 강점'),
  ('wordvice-ai', 'Wordvice AI', 'ai_research', 'domestic', 'https://wordvice.ai', '논문·에세이 영문 교정에 특화된 국내 AI 교정기.', true, null, null, null, '가입 후 바로 사용(무료 플랜 제공)', '학술 영문 교정·표절 검사에 강점'),
  ('immersive-translate', 'Immersive Translate', 'ai_research', 'overseas', 'https://immersivetranslate.com', '웹·PDF를 원문 대조로 번역하는 브라우저 확장.', true, null, null, null, '확장 설치 후 바로 사용(무료 플랜 제공)', '원문-번역 대조 읽기에 강점'),
  ('chatpdf', 'ChatPDF', 'ai_research', 'overseas', 'https://www.chatpdf.com', 'PDF를 업로드해 대화로 내용을 묻는 문서 AI.', true, null, null, null, '가입 없이 일부 사용(무료 플랜 제공)', '계약서·논문 PDF 질의응답에 강점')
on conflict (id) do nothing;
