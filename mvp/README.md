...
| `data/platforms.js` | `groups`(대분류 5) + `categories`(35, group 매핑) + `platforms`(1,559, `new:true`=신규) |
...
```
- **정적 감사 결과(현재):** 총 1,559개 · 중복 이름/ID 0 · 필드누락 0 · 잘못된 분야/지역 0 · URL형식 오류 0 → **구조적 결함 없음.**
